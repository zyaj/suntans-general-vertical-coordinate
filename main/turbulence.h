...
void my25(gridT *grid, physT *phys, propT *prop, REAL **wnew, REAL **q, REAL **q_old, REAL **l, REAL **l_old, REAL **Cn_q, REAL **Cn_l, REAL **nuT, REAL **kappaT, MPI_Comm comm, int myproc);
