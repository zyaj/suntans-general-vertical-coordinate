...
REAL **zc; // the cell center vertical location in the Cartesian coordinate [Nc][Nk]
REAL **dvdx, **dudy, **dwdx, **dwdy; // the cell-centered averaged gradient of different variables
...
void ComputeCellAveragedGradient(REAL **gradient, REAL **scalar, gridT *grid, propT *prop, physT *phys, int myproc);
