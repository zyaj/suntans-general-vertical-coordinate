 ...
 * Usage: provide wind stress at cell c for x and y direction
 * -----------------------------------------
 * only use for the calculation of cell average momentum balance
 *
 */
REAL ReturnCellWindStress(REAL x, REAL y, int n, REAL dt, int xyswitch)
{
  // xyswitch 1 means x direction otherwise y direction
  if(xyswitch==1)
    return 0.0;
  else
    return 0.0;
