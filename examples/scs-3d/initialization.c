...
REAL ReturnTemperature(REAL x, REAL y, REAL z, REAL depth) {
  REAL T = 30*exp(0.005*(z))*(1-0.3*tanh(0.01*(z+40)))+2;
...
REAL ReturnSediment(REAL x, REAL y, REAL z, int sizeno) {return 0;}
REAL ReturnBedSedimentRatio(REAL x, REAL y, int layer, int sizeno,int nsize) {return 0;}
